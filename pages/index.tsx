...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  rides = rides.map((ride: Ride) => {
    ...
    return {
      ...
      past: +date.parse(ride.date, 'MM/DD/YYYY hh:mm A') < today
    };
...
const Home: NextPage = ({ user, rides, filterOptions }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
    <>
      <Head>
      ...
      <Layout user={user} main={<Homepage rides={rides} userStation={user.station_code} filterOptions={filterOptions} />} />
    </>
  )
}
